...
void drawAxes(SDL_Renderer* renderer, SDL_Window *screen)
{
    ...
    SDL_RenderDrawLine(renderer,WINDOW_HEIGHT/2,0 + *MOVE_LENGTHX-AXES_LENGTH,WINDOW_WIDTH/2,SDL_GetWindowSurface(screen)->h + *MOVE_LENGTHX +AXES_LENGTH); //axe horizontal
}
void drawTransGrid(SDL_Renderer* renderer)
{
    ...
    for(i=0;i<GridBarCounts;i++){
            SDL_RenderDrawLine(renderer,i* *RESIZER_MULTIPLIER+WINDOW_WIDTH/2+ *MOVE_LENGTHY,WINDOW_HEIGHT + *MOVE_LENGTHX,i* *RESIZER_MULTIPLIER+WINDOW_WIDTH/2 + *MOVE_LENGTHY,0 + *MOVE_LENGTHX);//axe x positif
            SDL_RenderDrawLine(renderer,-i* *RESIZER_MULTIPLIER+WINDOW_WIDTH/2+ *MOVE_LENGTHY  ,WINDOW_HEIGHT + *MOVE_LENGTHX,-i* *RESIZER_MULTIPLIER+WINDOW_WIDTH/2+ *MOVE_LENGTHY,0+ *MOVE_LENGTHX);//axe x negatif
            SDL_RenderDrawLine(renderer,0+ *MOVE_LENGTHY,i* *RESIZER_MULTIPLIER+WINDOW_WIDTH/2+ *MOVE_LENGTHX,WINDOW_WIDTH + *MOVE_LENGTHY,i* *RESIZER_MULTIPLIER+WINDOW_WIDTH/2+ *MOVE_LENGTHX);//axe y negatif
            SDL_RenderDrawLine(renderer,0+ *MOVE_LENGTHY,i* *RESIZER_MULTIPLIER+ *MOVE_LENGTHX,WINDOW_WIDTH + *MOVE_LENGTHY,i* *RESIZER_MULTIPLIER+ *MOVE_LENGTHX);//axe y positif
        }
}
...
void drawGrid(SDL_Renderer* renderer)
{
    ...
    int i;
    for(i=0;i<GridBarCounts;i++){
            SDL_RenderDrawLine(renderer,i* *RESIZER_MULTIPLIER+WINDOW_WIDTH/2 + *MOVE_LENGTHY ,(-*RESIZER_MULTIPLIER/10)+centerCoordY + *MOVE_LENGTHX,i* *RESIZER_MULTIPLIER+WINDOW_WIDTH/2 + *MOVE_LENGTHY,( *RESIZER_MULTIPLIER/10)+centerCoordY+ *MOVE_LENGTHX );//axe x positif
            SDL_RenderDrawLine(renderer,i* *RESIZER_MULTIPLIER + *MOVE_LENGTHY,(- *RESIZER_MULTIPLIER/10)+centerCoordY + *MOVE_LENGTHX,i* *RESIZER_MULTIPLIER + *MOVE_LENGTHY,(*RESIZER_MULTIPLIER/10)+centerCoordY + *MOVE_LENGTHX);// axe x negatif
            SDL_RenderDrawLine(renderer,-1*(*RESIZER_MULTIPLIER/10)+centerCoordX + *MOVE_LENGTHY,i* *RESIZER_MULTIPLIER + *MOVE_LENGTHX,1*(*RESIZER_MULTIPLIER/10)+centerCoordX + *MOVE_LENGTHY,i* *RESIZER_MULTIPLIER + *MOVE_LENGTHX);
            SDL_RenderDrawLine(renderer,-1*(*RESIZER_MULTIPLIER/10)+centerCoordX + *MOVE_LENGTHY,i* *RESIZER_MULTIPLIER+centerCoordY + *MOVE_LENGTHX,1*(*RESIZER_MULTIPLIER/10)+centerCoordX + *MOVE_LENGTHY,i* *RESIZER_MULTIPLIER+centerCoordY + *MOVE_LENGTHX);
        }
}
...
void drawCurv2(SDL_Renderer* renderer,float point[3][NBPOINTS], SDL_Window* screen)
{
    ...
    for(i=0;i<NBPOINTS;i++){
            SDL_RenderDrawPoint(renderer,(point[0][i] * *RESIZER_MULTIPLIER)+WINDOW_WIDTH/2+ *MOVE_LENGTHY,point[1][i]* *RESIZER_MULTIPLIER+(SDL_GetWindowSurface(screen)->h)/2 + *MOVE_LENGTHX);
        }
}
void drawCurv2Neg(SDL_Renderer* renderer,float points[3][NBPOINTS], SDL_Window* screen)
{
    int i;
    for(i=0;i>=-NBPOINTS;i--){
        SDL_RenderDrawPoint(renderer,(points[0][-i] * *RESIZER_MULTIPLIER)+WINDOW_WIDTH/2 + *MOVE_LENGTHY,points[1][-i]* *RESIZER_MULTIPLIER+(SDL_GetWindowSurface(screen)->h)/2 + *MOVE_LENGTHX);
    }
